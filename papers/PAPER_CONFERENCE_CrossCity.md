...
Proactive Transformer–LSTM Predictor from Beijing and Hong Kong to Tokyo"**
...
> degradation predictor and a strong gradient-boosted baseline, both trained on Beijing and
...
- Beijing: dense, grid-like, inland, wide avenues.
...
- Beijing field (Scenarios A–E, Septentrio) + Hong Kong UrbanNav.
...
- Metrics: macro-F1, per-class F1, generalisation gap (Tokyo − Beijing).
...
| Model | Beijing macro-F1 | Tokyo macro-F1 | Gap | Retention |
|-------|-----------------:|---------------:|----:|----------:|
...
- Trees partition on absolute feature thresholds calibrated to Beijing's distribution;
