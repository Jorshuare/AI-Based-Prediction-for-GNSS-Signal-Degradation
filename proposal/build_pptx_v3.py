...
def make_dataset_expansion_slide(prs):
    ...
    rows = [
        ...
        ("UrbanNav HK Tunnel",           "Hong Kong, China",
         "10 receivers",    "3,461",   "A E"),
        ("UrbanNav Tokyo Odaiba",        "Tokyo, Japan",
         "Trimble/u-blox", "18,603",  "C D"),
        ("UrbanNav Tokyo Shinjuku",      "Tokyo, Japan",
         "Trimble/u-blox", "31,265",  "B C"),
        ("NCLT (2 sessions)",            "Ann Arbor, USA",
         "GPS + LiDAR GT", "7,493",   "B D"),
        ("Oxford RobotCar (2 sessions)", "Oxford, UK",
         "NovAtel OEM6",   "7,114",   "B C D"),
    ]
