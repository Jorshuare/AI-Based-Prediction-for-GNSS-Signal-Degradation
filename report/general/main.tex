...
\begin{titlepage}
  ...
  {\large\color{buaaBlue} SENTINEL-GNSS}\\[0.35cm]
  {\Huge\bfseries\color{buaaNavy} AI-Based Proactive Prediction of\\[0.15cm]
   GNSS Signal Degradation for\\[0.15cm] Autonomous Vehicle Navigation}\\[0.6cm]
  {\Large\color{buaaBlue} Group Report}\\[0.7cm]
