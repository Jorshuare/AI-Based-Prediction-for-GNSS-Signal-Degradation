...
\begin{tcolorbox}[
  ...
  \begin{center}
    ...
    {\normalsize\color{white!70!buaaSky}
     School of Electronics and Information Engineering (H3I) · Beihang University · Beijing 2025}
  \end{center}
\end{tcolorbox}
...
\begin{poblock}
\textbf{Hybrid Transformer + BiLSTM} (1.46\,M parameters)

\begin{itemize}
  \item \textbf{Transformer encoder} (2 layers, 4 heads, $d=128$):
    captures global satellite-geometry trends across the 60-second window
  \item \textbf{BiLSTM} (2 layers, hidden 256):
    captures sequential approach dynamics (gradual C/N$_0$ decline)
  \item \textbf{Three output heads:} $+5$\,s, $+15$\,s, $+30$\,s
...
\begin{center}
  \includegraphics[width=0.92\columnwidth]{../../results/paper_figures/fig14_architecture.pdf}
...
\medskip
\textbf{10.5$\times$ faster} than three separate tree models; 0.039\,ms/sample.
\end{poblock}

\begin{center}
  \includegraphics[width=\columnwidth]{../../results/figures/multi_horizon_comparison.pdf}
...
\begin{itemize}
  ...
  \item The hybrid Transformer+BiLSTM \textbf{transfers across cities};
...
\medskip
\textbf{Code:} \texttt{github.com/Jorshuare/AI-Based-Prediction-for-GNSS-Signal-Degradation}
\end{poblock}
...
\begin{center}
  {\small\color{buaaNavy}
   ...
   \textbf{Institution:} Beihang University (BUAA) H3I, Beijing, China \quad
   \textbf{Year:} 2025}
\end{center}
