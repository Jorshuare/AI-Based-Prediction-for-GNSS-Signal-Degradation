...
\begin{itemize}
  ...
  \item 30-paper annotated spreadsheet (method, dataset, relevance)
  ...
  \item Paper Section 2: Related Work (800 words, 30 papers)
\end{itemize}
\end{poblock}
...
\begin{tabular}{lcc}
  ...
  \midrule
  Random Forest & \textbf{0.910} & 0.789 \\
  XGBoost       & 0.919 & 0.810 \\
...
\textbf{In-domain}: Macro-F1\,=\,0.910 ✓ (beats DL)\\
...
XGBoost transfers \emph{better} than RF to Tokyo (DEG F1\,=\,0.784 vs RF 0.148),
...
\begin{poblock}
Section 2 structure (30 papers, 800 words):
